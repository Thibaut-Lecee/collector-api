...
export declare type GetFindResult<P extends OperationPayload, A, GlobalOmitOptions> = Equals<A, any> extends 1
 ...
 * ```
 */
export declare type SqlCommenterPlugin = (context: SqlCommenterContext) => SqlCommenterTags;
...
declare namespace Transaction_2 {
  export { IsolationLevel_2 as IsolationLevel, Options, InteractiveTransactionInfo, TransactionHeaders };
}
