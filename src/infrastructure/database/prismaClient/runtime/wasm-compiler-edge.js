...
var oe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  $i = (e, t, r, n) => {
    if ((t && typeof t == 'object') || typeof t == 'function')
      for (let i of fu(t))
        !yu.call(e, i) && i !== r && mr(e, i, { get: () => t[i], enumerable: !(n = du(t, i)) || n.enumerable });
    return e;
  };
var $e = (e, t, r) => (
    (r = e != null ? mu(gu(e)) : {}),
    $i(t || !e || !e.__esModule ? mr(r, 'default', { value: e, enumerable: !0 }) : r, e)
  ),
...
function hu(e) {
  ...
  n.forEach((a, d) => {
    a.startsWith('read') && ((e[a] = i(d, !1)), (e[a + 'LE'] = i(d, !0)), (e[a + 'BE'] = i(d, !1))),
      a.startsWith('write') && ((e[a] = o(d, !1)), (e[a + 'LE'] = o(d, !0)), (e[a + 'BE'] = o(d, !1))),
      s([a, a + 'LE', a + 'BE']);
  });
}
function Bi(e) {
...
var h,
  ...
  l = fe(() => {
    ...
    h = class e extends Uint8Array {
      ...
      equals(t) {
        return dr(t, 'otherBuffer'), this.length === t.length && this.every((r, n) => r === t[n]);
      }
        ...
        return (
          ...
          s.length === 0 && i === !1
            ...
            : s.length === 0 && i === !0
              ...
              : o((d, f) => (i ? f <= a : f >= a) && this[f] === s[0] && s.every((A, S) => this[f + S] === A))
        );
      }
      toString(t = 'utf8', r = 0, n = this.length) {
        ...
        if (t === 'binary' || t === 'ascii' || t === 'latin1' || t === 'latin-1')
          return this.slice(r, n).reduce((i, o) => i + Tn(o & (t === 'ascii' ? 127 : 255)), '');
        if (t === 'ucs2' || t === 'ucs-2' || t === 'utf16le' || t === 'utf-16le') {
...
function ge(e) {
  var t,
    ...
    s = e[0];
  if (i > 0) {
    for (o += s, t = 1; t < i; t++) (n = e[t] + ''), (r = $ - n.length), r && (o += Ie(r)), (o += n);
...
function Wi(e, t) {
  ...
  for (t == null ? ((B = !1), (a = A)) : (a = t), s = new P(0.03125); e.abs().gte(0.1); ) (e = e.times(s)), (f += 5);
  for (n = ((Math.log(qe(2, f)) / Math.LN10) * 2 + 5) | 0, a += n, r = i = o = new P(se), P.precision = a; ; ) {
    if (
      ((i = _(i.times(e), a)),
      (r = r.times(++d)),
      (s = o.plus(ve(i, r, a))),
...
function Pn(e, t, r) {
  if (t > e.LN10.sd()) throw ((B = !0), r && (e.precision = r), Error(le + 'LN10 precision limit exceeded'));
...
function St(e, t) {
  ...
  if ((t == null ? ((B = !1), (f = k)) : (f = t), C.eq(10))) return t == null && (B = !0), Pn(R, f);
...
function ji(e, t) {
  ...
  if (((t = t.slice(n, i)), t)) {
    if (((i -= n), (r = r - n - 1), (e.e = tt(r / $)), (e.d = []), (n = (r + 1) % $), r < 0 && (n += $), n < i)) {
...
function _(e, t, r) {
        ...
        r < 4
          ...
          : a > 5 ||
            (a == 5 &&
              (r == 4 ||
                d ||
                (r == 6 && ((n > 0 ? (i > 0 ? f / qe(10, s - i) : 0) : A[P - 1]) % 10) & 1) ||
                r == (e.s < 0 ? 8 : 7))))),
    t < 1 || !A[0])
  )
    return (
      d
        ? ((o = J(e)), (A.length = 1), (t = t - o - 1), (A[0] = qe(10, ($ - (t % $)) % $)), (e.e = tt(-t / $) || 0))
  ...
  if (
    (n == 0
      ? ((A.length = P), (o = 1), P--)
      : ((A.length = P + 1), (o = qe(10, $ - n)), (A[P] = i > 0 ? (((f / qe(10, s - i)) % qe(10, i)) | 0) * o : 0)),
    d)
  )
    for (;;)
      if (P == 0) {
...
function Gi(e, t) {
  ...
  for (P && ((r = d), (d = A), (A = r), (t.s = -t.s)), a = d.length, i = A.length - a; i > 0; --i) d[a++] = 0;
  for (i = A.length; i > s; ) {
    if (d[--i] < A[i]) {
...
function Ki(e) {
  ...
  function i(o) {
    ...
    if ((o.charCodeAt(0) === 45 ? ((o = o.slice(1)), (s.s = -1)) : (s.s = 1), Cu.test(o))) ji(s, o);
...
function Su(e) {
  ...
  var t,
    r,
    n,
    i = ['precision', 1, et, 'rounding', 0, 8, 'toExpNeg', -1 / 0, 0, 'toExpPos', 0, 1 / 0];
...
var et,
  ...
  Zi = fe(() => {
    ...
    v.logarithm = v.log = function (e) {
      ...
      return r.eq(se) ? new n(0) : ((B = !1), (t = ve(St(r, o), St(e, o), o)), (B = !0), _(t, i));
    };
    v.minus = v.sub = function (e) {
      var t = this;
      return (e = new t.constructor(e)), t.s == e.s ? Gi(t, e) : Ji(t, ((e.s = -e.s), e));
    };
    v.modulo = v.mod = function (e) {
      ...
      return r.s ? ((B = !1), (t = ve(r, e, 0, 1).times(e)), (B = !0), r.minus(t)) : _(new n(r), i);
    };
    ...
    v.plus = v.add = function (e) {
      var t = this;
      return (e = new t.constructor(e)), t.s == e.s ? Ji(t, e) : Gi(t, ((e.s = -e.s), e));
    };
    ...
    v.times = v.mul = function (e) {
      ...
      for (
        ...
        o.push(0);
      for (n = f; --n >= 0; ) {
        for (t = 0, i = d + n; i > n; ) (a = o[i] + C[n] * S[i - n - 1] + t), (o[i--] = (a % G) | 0), (t = (a / G) | 0);
        o[i] = ((o[i] + t) % G) | 0;
      }
      for (; !o[--s]; ) o.pop();
    ...
    v.toDecimalPlaces = v.todp = function (e, t) {
      ...
      return (
        (r = new n(r)),
        e === void 0 ? r : (ye(e, 0, et), t === void 0 ? (t = n.rounding) : ye(t, 0, 8), _(r, e + J(r) + 1, t))
      );
    };
    ...
    ve = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (d = n.e - i.e, ce = Q.length, Ue = de.length, C = new pr(pu), M = C.d = [], f = 0; Q[f] == (de[f] || 0); )
          ++f;
        if (
          (Q[f] > (de[f] || 0) && --d,
          o == null ? (re = o = pr.precision) : s ? (re = o + (J(n) - J(i)) + 1) : (re = o),
          re < 0)
        )
          return new pr(0);
        if (((re = (re / $ + 2) | 0), (f = 0), ce == 1))
          ...
          for (
            P = (G / (Q[0] + 1)) | 0,
              P > 1 && ((Q = e(Q, P)), (de = e(de, P)), (ce = Q.length), (Ue = de.length)),
              ne = ce,
              R = de.slice(0, ce),
              k = R.length;
            k < ce;
            ...
            (P = 0),
              ...
              a < 0
                ? ((Ae = R[0]),
                  ...
                  S < k && A.unshift(0),
                  r(R, A, k),
                  a == -1 && ((k = R.length), (a = t(Q, R, ce, k)), a < 1 && (P++, r(R, ce < k ? cr : Q, k))),
                  (k = R.length))
                : a === 0 && (P++, (R = [0])),
              (M[f++] = P),
...
var Mt,
  ...
  je = fe(() => {
    ...
    (kt = class {
      ...
      (nt = { webcrypto: Mt, randomUUID: wr, randomFillSync: br, createHash: ho, Hash: kt });
  });
var wo = oe(() => {
  'use strict';
  l();
...
var wa = oe((O) => {
  ...
  O.add4H = ga;
  var ya = (e, t, r, n, i) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (n >>> 0) + (i >>> 0);
  O.add5L = ya;
...
var Ta = oe((D) => {
  ...
  var Ap = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, '0'));
  function vp(e) {
    (0, ai.abytes)(e);
    let t = '';
  ...
  function Dp(e = 32) {
    ...
    if (bt.crypto && typeof bt.crypto.randomBytes == 'function') return bt.crypto.randomBytes(e);
...
var Oa = oe((V) => {
  ...
  for (let e = 0, t = zt, r = 1, n = 0; e < 24; e++) {
    ([r, n] = [n, (2 * r + 3 * n) % 5]), va.push(2 * (5 * n + r)), Ca.push((((e + 1) * (e + 2)) / 2) % 64);
    let i = Lp;
    for (let o = 0; o < 7; o++)
      (t = ((t << zt) ^ ((t >> Fp) * $p)) % Up), t & _p && (i ^= zt << ((zt << BigInt(o)) - zt));
    Sa.push(i);
  }
  var [qp, Vp] = (0, Zt.split)(Sa, !0),
    Pa = (e, t, r) => (r > 32 ? (0, Zt.rotlBH)(e, t, r) : (0, Zt.rotlSH)(e, t, r)),
    Aa = (e, t, r) => (r > 32 ? (0, Zt.rotlBL)(e, t, r) : (0, Zt.rotlSL)(e, t, r));
  function Ra(e, t = 24) {
  ...
  var Yt = class e extends Re.Hash {
    ...
    digestInto(t) {
      if (((0, xt.aoutput)(t, this), this.finished)) throw new Error('digest() was already called');
  ...
  var Ia = (e, t, r) =>
    (0, Re.wrapXOFConstructorWithOpts)((n = {}) => new Yt(t, e, n.dkLen === void 0 ? r : n.dkLen, !0));
...
var Rn,
  ...
  so = !0;
typeof g < 'u' &&
  (({ FORCE_COLOR: Rn, NODE_DISABLE_COLORS: no, NO_COLOR: io, TERM: oo } = g.env || {}),
  (so = g.stdout && g.stdout.isTTY));
var Ru = { enabled: !no && io == null && oo !== 'dumb' && ((Rn != null && Rn !== '0') || so) };
function U(e, t) {
  let r = new RegExp(`\\x1b\\[${t}m`, 'g'),
    n = `\x1B[${e}m`,
    i = `\x1B[${t}m`;
  return function (o) {
    return !Ru.enabled || o == null ? o : n + (~('' + o).indexOf(i) ? o.replace(r, i + n) : o) + i;
  };
}
var rg = U(0, 0),
  gr = U(1, 22),
...
function ku(e) {
  let t = { color: mo[Ou++ % mo.length], enabled: Ot.enabled(e), namespace: e, log: Ot.log, extend: () => {} },
    r = (...n) => {
      let { enabled: i, namespace: o, color: s, log: a } = t;
      if ((n.length !== 0 && It.push([o, ...n]), It.length > Iu && It.shift(), Ot.enabled(o) || i)) {
...
p();
m();
var Nt = { error: rt('prisma:error'), warn: lo('prisma:warn'), info: co('prisma:info'), query: uo('prisma:query') },
...
var qu = $e(Ao());
var Vu = { red: rt, gray: po, dim: yr, bold: gr, underline: hr, highlightSource: (e) => e.highlight() },
  Bu = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function vr(e) {
  let t = e.showColors ? Vu : Bu,
    r;
  return typeof $getTemplateParameters < 'u' ? (r = $getTemplateParameters(e, t)) : (r = ju(e)), Qu(r, t);
}
l();
u();
c();
...
function Ju(e) {
  ...
  for (let n of e) {
    ...
    let i = `${n.selectionPath.join('.')}:${n.argumentPath.join('.')}`,
      o = t.get(i);
    o
      ? t.set(i, { ...n, argument: { ...n.argument, typeNames: Wu(o.argument.typeNames, n.argument.typeNames) } })
      : t.set(i, n);
  }
...
var ct = class e extends ke {
  ...
  getDeepField(t) {
    ...
    for (let s of n) {
      let a;
      if (
        (o.value instanceof e ? (a = o.value.getField(s)) : o.value instanceof ut && (a = o.value.getField(Number(s))),
        !a)
      )
        return;
      o = a;
...
function oc(e, t) {
  ...
  if (a) {
    ...
    if (e.dependentArgumentPath) {
      ...
      t.addErrorMessage(
        (f) => `Argument \`${f.green(o)}\` is required because argument \`${f.green(d)}\` was provided.`,
      );
    }
  }
}
...
function Bo(e, t) {
  if (t.kind === 'object')
    for (let r of t.fields) e.hasField(r.name) || e.addSuggestion(new ae(r.name, r.typeNames.join(' | ')));
}
function pt(e) {
  let t = [...e],
    r = t.pop();
...
var jo = ': ',
  kr = class {
    ...
    write(t) {
      ...
      this.hasError && r.underline().setColor(t.context.colors.red), t.write(r).write(jo).write(this.value);
    }
  };
var $n = class {
  arguments;
...
function Nr({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: d, args: f } = Mr(a, r),
    P = vr({ message: d, callsite: n, originalMethod: i, showColors: r === 'pretty', callArguments: f });
...
function Ko(e, t, r) {
  ...
  return !t.result || !(t.result.$allModels || t.result[n])
    ? e
    : hc({ ...e, ...Go(t.name, e, t.result.$allModels), ...Go(t.name, e, t.result[n]) });
}
function hc(e) {
  let t = new he(),
    r = (n, i) =>
...
var es = Symbol(),
  Vt = class {
    constructor(t) {
      if (t !== es) throw new Error('Skip instance can not be constructed directly');
    }
    ifUndefined(t) {
...
function Ec(e, t, r) {
  let n = {};
  return (
    e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Tc(n, t, e), Pc(n, r, e), n
  );
}
function Tc(e, t, r) {
...
function Vn(e, t) {
  e === void 0 &&
    t.isPreviewFeatureOn('strictUndefinedChecks') &&
    t.throwValidationError({ kind: 'InvalidSelectionValue', selectionPath: t.getSelectionPath(), underlyingError: ts });
}
var qn = class e {
  constructor(t) {
    this.params = t;
...
var jn = new WeakMap(),
  ...
  jt = class {
    constructor(t, r) {
      jn.set(this, { sql: t, values: r }), Object.defineProperty(this, Ur, { value: Ur });
    }
    get sql() {
  ...
  let r = Ic(t),
    ...
    i = new Proxy(e, {
      ...
      getOwnPropertyDescriptor(o, s) {
        ...
        let d = r.get(s);
        return d ? (d.getPropertyDescriptor ? { ...Vr, ...d?.getPropertyDescriptor(s) } : Vr) : a;
      },
...
function yt(e = {}) {
  let t = kc(e);
  return Object.entries(t).reduce((n, [i, o]) => (cs[i] !== void 0 ? (n.select[i] = { select: o }) : (n[i] = o), n), {
    select: {},
  });
}
function kc(e = {}) {
...
function Mc(e = {}) {
  let { select: t, ...r } = e;
  return typeof t == 'object' ? yt({ ...r, _count: t }) : yt({ ...r, _count: { _all: !0 } });
}
function Nc(e = {}) {
...
var ys = (e) => (Array.isArray(e) ? e : e.split('.')),
  ...
  hs = (e, t, r) => ys(t).reduceRight((n, i, o, s) => Object.assign({}, Hn(e, s.slice(0, o)), { [i]: n }), r);
function _c(e, t) {
...
var $c = ['findUnique', 'findUniqueOrThrow', 'findFirst', 'findFirstOrThrow', 'create', 'update', 'upsert', 'delete'],
  qc = ['aggregate', 'count', 'groupBy'];
function Wn(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Vc(e, t), jc(e, t), Qt(r), te('name', () => t), te('$name', () => t), te('$parent', () => e._appliedParent)];
  return pe({}, n);
}
function Vc(e, t) {
  let r = be(t),
...
var Gn = Symbol();
function Ht(e) {
  let t = [Qc(e), Hc(e), te(Gn, () => e), te('$parent', () => e._appliedParent)],
...
function Qr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
  ...
  let o = e(t, i, r) ?? t;
  return (
    r.include && Ts({ includeOrSelect: r.include, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    r.select && Ts({ includeOrSelect: r.select, result: o, parentModelName: i, runtimeDataModel: n, visitor: e }),
    o
  );
}
function Ts({ includeOrSelect: e, result: t, parentModelName: r, runtimeDataModel: n, visitor: i }) {
  for (let [o, s] of Object.entries(e)) {
    ...
    t[o] = Qr({ visitor: i, result: t[o], args: f, modelName: d.type, runtimeDataModel: n });
  }
}
...
function Jt(e) {
  if (typeof e != 'object' || e == null || e instanceof He.ObjectEnumValue || mt(e)) return e;
      ...
      n === r.length
        ...
        : r[n]({
            ...
            query: (s, a = t) => {
              ...
              return (a.customDataProxyFetch = ks(o, d)), (a.args = s), Ss(e, a, r, n + 1);
            },
          })
    );
  });
...
function ht(e, t) {
  ...
  return (r.length < n.length ? r : n).every((o) => {
    ...
    if (Wt.Decimal.isDecimal(e[o]) || Wt.Decimal.isDecimal(t[o])) {
      ...
      if (typeof e[o] == 'bigint' || typeof t[o] == 'bigint') return Ls(e[o]) === Ls(t[o]);
      if (typeof e[o] == 'number' || typeof t[o] == 'number') return _s(e[o]) === _s(t[o]);
    }
    return Kn(e[o], t[o]);
  });
}
function Ms(e) {
  return Wt.Decimal.isDecimal(e) ? e : typeof e == 'number' || typeof e == 'string' ? new Wt.Decimal(e) : void 0;
}
function Ns(e) {
  return y.isBuffer(e)
    ? e
...
function Yn(e, t, r, n) {
  switch (r.type) {
    ...
    case 'decimal':
      if (typeof e != 'number' && typeof e != 'string' && !Bs.Decimal.isDecimal(e))
...
function ip(e) {
  ...
  let r = e,
    [n, i, o] = t;
  if (
    (i !== void 0 && i !== 'Z' && o === void 0 ? (r = `${e}:00`) : i === void 0 && (r = `${e}Z`), n.length === e.length)
  )
...
function Ee(e) {
  ...
  if (n === '[object Object]') {
    if (e.constructor !== Object && typeof e.constructor == 'function') {
      ...
      for (t in e)
        t === '__proto__'
          ? Object.defineProperty(r, t, { value: Ee(e[t]), configurable: !0, enumerable: !0, writable: !0 })
          : (r[t] = Ee(e[t]));
    }
    return r;
  }
...
async function Wr({ query: e, tracingHelper: t, provider: r, onQuery: n, execute: i }) {
  let o =
    n === void 0
      ? i
      : async () => {
          let s = new Date(),
            ...
            d = await i(),
            f = w.now();
          return n({ timestamp: s, duration: f - a, query: e.sql, params: e.args }), d;
        };
  return t.isEnabled()
    ? await t.runInChildSpan(
        { name: 'db_query', kind: Kt.CLIENT, attributes: { 'db.query.text': e.sql, 'db.system.name': sp(r) } },
        o,
      )
    : o();
}
...
function im(e, t = ja) {
  if (isNaN(e)) throw new ze(Ke.EncodeTimeValueMalformed, `Time must be a number: ${e}`);
  if (e > Va) throw new ze(Ke.EncodeTimeSizeExceeded, `Cannot encode a time larger than ${Va}: ${e}`);
  if (e < 0) throw new ze(Ke.EncodeTimeNegative, `Time must be positive: ${e}`);
  if (Number.isInteger(e) === !1) throw new ze(Ke.EncodeTimeValueMalformed, `Time must be an integer: ${e}`);
  let r,
    n = '';
  for (let i = t; i > 0; i--) (r = e % tr), (n = Ba.charAt(r) + n), (e = (e - r) / tr);
  return n;
}
function om() {
...
m();
function rn(e, t) {
  return e == null ? e : typeof e == 'string' ? rn(JSON.parse(e), t) : Array.isArray(e) ? cm(e, t) : um(e, t);
}
function um(e, t) {
  if (t.pagination) {
    let { skip: r, take: n, cursor: i } = t.pagination;
    if ((r !== null && r > 0) || n === 0 || (i !== null && !ht(e, i))) return null;
  }
...
function mm(e, t, r) {
  ...
  return i.sort(([o], [s]) => (o < s ? -1 : o > s ? 1 : 0)), i.flatMap(([, o]) => Wa(o, t));
}
...
function fm(e, t, r) {
  ...
  switch (n) {
    ...
    case 'parameterTupleList':
      return e.value
        .map((i) => {
          let o = i.map(() => Pi(t, r.placeholderNumber++)).join(e.itemSeparator);
    ...
    switch (s.type) {
      ...
      case 'parameterTupleList': {
        ...
        for (let A of s.value)
          r && o.length === 1 && a === i && f.length > 0 && n - a + P + A.length > r && (d.push(f), (f = []), (P = 0)),
            f.push(A),
            (P += A.length);
...
var nr = class e {
  ...
  async run(t, r) {
    let { value: n } = await this.interpretNode(t, { ...r, generators: this.#e.snapshot() }).catch((i) => wt(i));
    return n;
  }
  async interpretNode(t, r) {
    switch (t.type) {
      ...
      case 'concat': {
        ...
        return { value: n.length > 0 ? n.reduce((i, o) => i.concat(Si(o)), []) : [] };
      }
      case 'sum': {
        let n = await Promise.all(t.args.map((i) => this.interpretNode(i, r).then((o) => o.value)));
      ...
      case 'execute': {
        ...
        for (let o of n) {
          ...
          i += await this.#l(s, r.queryable, () =>
            r.queryable.executeRaw(s).catch((a) => (t.args.type === 'rawSql' ? Zn(a) : wt(a))),
          );
        }
        return { value: i };
      }
        ...
        for (let o of n) {
          let s = el(o, r.sqlCommenter),
            a = await this.#l(s, r.queryable, () =>
              r.queryable.queryRaw(s).catch((d) => (t.args.type === 'rawSql' ? Zn(d) : wt(d))),
            );
      ...
      case 'dataMap': {
        ...
        return { value: js(n, t.args.structure, t.args.enums), lastInsertId: i };
      }
      case 'validate': {
        let { value: n, lastInsertId: i } = await this.interpretNode(t.args.expr, r);
      ...
      case 'if': {
        ...
        return Ci(n, t.args.rule) ? await this.interpretNode(t.args.then, r) : await this.interpretNode(t.args.else, r);
      }
      case 'unit':
        return { value: void 0 };
      case 'diff': {
      ...
      case 'initializeRecord': {
        let { lastInsertId: n } = await this.interpretNode(t.args.expr, r),
          i = {};
        for (let [o, s] of Object.entries(t.args.fields)) i[o] = Pm(s, n, r.scope, r.generators);
  ...
  #l(t, r, n) {
    return Wr({ query: t, execute: n, provider: this.#i ?? r.provider, tracingHelper: this.#n, onQuery: this.#t });
  }
};
function Xa(e) {
...
function tl(e, t) {
  return Array.isArray(e) ? e.map((r) => tl(r, t)) : typeof e == 'object' && e !== null ? (e[t] ?? null) : e;
}
function Tm(e, t) {
  for (let { joinExpr: r, childRecords: n } of t) {
    ...
    for (let a of Array.isArray(n) ? n : [n]) {
      if (a === null) continue;
      let d = Pt(nn(a), o);
      for (let f of s[d] ?? []) r.isRelationUnique ? (f[r.parentField] = a) : f[r.parentField].push(a);
    }
  }
  return e;
}
...
var Cm = 100,
  ...
  Im = () => ({ sql: '-- Implicit "COMMIT" query via underlying driver', args: [], argTypes: [] }),
  Om = () => ({ sql: '-- Implicit "ROLLBACK" query via underlying driver', args: [], argTypes: [] }),
  or = class {
    ...
    async #n(t) {
      ...
      switch (
        ((r.transaction = await Promise.race([o.finally(() => clearTimeout(i)), nl(n.signal, 'abort').then(() => {})])),
        ...
        case 'waiting':
          if (n.signal.aborted)
            throw (
              (o.then((s) => s.rollback()).catch((s) => vt('error in discarded transaction:', s)),
    ...
    async getTransaction(t, r) {
      let n = this.#r(t.id, r);
      if ((n.status === 'closing' && (await n.closing, (n = this.#r(t.id, r))), !n.transaction)) throw new ir();
        ...
        if (i)
          switch ((vt('Transaction already closed.', { transactionId: t, status: i.status }), i.status)) {
            ...
            case 'rolled_back':
              throw new sn(r);
            case 'timed_out':
              throw new ln(r, { timeout: i.timeout, timeTaken: Date.now() - i.startedAt });
          }
      ...
      let n = Date.now(),
        i = il(async () => {
          ...
          o && ['running', 'waiting'].includes(o.status)
            ...
            : vt('Transaction already committed or rolled back when timeout happened.', t);
        }, r);
      return i?.unref?.(), i;
    }
    async #i(t, r) {
      let n = async () => {
        ...
        try {
          if (t.transaction && r === 'committed')
            if (t.transaction.options.usePhantomQuery) await this.#a(Im(), t.transaction, () => t.transaction.commit());
            else {
              let i = Sm();
              await this.#a(i, t.transaction, () => t.transaction.executeRaw(i)).then(
            ...
            if (t.transaction.options.usePhantomQuery)
              await this.#a(Om(), t.transaction, () => t.transaction.rollback());
            else {
              let i = Rm();
              try {
          ...
          (t.status = r),
            ...
            this.closedTransactions.length > Cm && this.closedTransactions.shift();
        }
      };
      t.status === 'closing'
        ? (await t.closing, this.#r(t.id, r === 'committed' ? 'commit' : 'rollback'))
...
p();
m();
var ol = { bigint: 'bigint', date: 'datetime', decimal: 'decimal', bytes: 'bytes' };
function al(e) {
  let t;
  try {
    t = JSON.parse(e);
...
var pn = class e {
  ...
  async execute({ plan: t, placeholderValues: r, transaction: n, batchIndex: i, queryInfo: o }) {
    ...
    return await this.#o.run(t, {
      queryable: s,
      transactionManager: n ? { enabled: !1 } : { enabled: !0, manager: this.#n },
      scope: r,
...
function gl(e, t, r) {
  ...
  if (n.expires) {
    if (!Nm(n.expires) || Number.isNaN(n.expires.valueOf())) throw new TypeError('option expires is invalid');
...
var El = X('prisma:client:clientEngine:remoteExecutor'),
  yn = class {
    ...
    constructor(t) {
      ...
      let { url: r, apiKey: n } = wl({ clientVersion: t.clientVersion, accelerateUrl: t.accelerateUrl });
      (this.#n = new Ii(r)),
        (this.#e = new gn({
          apiKey: n,
    ...
    async execute({
      ...
      return (
        await this.#s({
          ...
          method: 'POST',
          body: { model: i, operation: o, plan: t, params: r, comments: f && Object.keys(f).length > 0 ? f : void 0 },
          batchRequestIdx: n,
          fetch: a,
        })
      ).data;
    ...
    #r(t) {
      ...
      for (let [i, o] of this.#e) {
        ...
        let s = o.domain ?? t.hostname,
          a = o.path ?? '/';
        t.hostname.endsWith(s) && t.pathname.startsWith(a) && r.push(gl(o.name, o.value));
      }
...
var ki = require('@prisma/client-runtime-utils'),
  ...
  Tl = {
    async loadQueryCompiler(e) {
      ...
      if (r === void 0)
        throw new ki.PrismaClientInitializationError('WASM query compiler was unexpectedly `undefined`', t);
      let n;
      return (
...
var ar = class {
  ...
  #o;
  constructor(t, r) {
    if (t.accelerateUrl !== void 0) this.#r = { remote: !0, accelerateUrl: t.accelerateUrl };
    else if (t.adapter)
      (this.#r = { remote: !1, driverAdapterFactory: t.adapter }), sr('Using driver adapter: %O', t.adapter);
    else
    ...
    (this.#n = r ?? Tl),
      ...
      this.logQueries &&
        (this.#o = (n) => {
          this.logEmitter.emit('query', { ...n, params: Gt(n.params), target: 'ClientEngine' });
        });
  }
  async #i() {
    switch (this.#e.type) {
  ...
  async #a(t) {
    ...
    try {
      return this.#c(() => new r({ datamodel: this.datamodel, provider: n, connectionInfo: i }), void 0, !1);
    } catch (o) {
      throw this.#u(o);
    }
  }
  ...
  #l(t, r) {
    ...
    if (t.code === 'GenericFailure' && t.message?.startsWith('PANIC:'))
      return new Y.PrismaClientRustPanicError(Pl(this, t.message, r), this.config.clientVersion);
    if (t instanceof z)
...
${n.backtrace}`,
    ...
    return t instanceof Y.PrismaClientRustPanicError
      ...
      : typeof t.message == 'string' && typeof t.code == 'string'
        ...
        : typeof t.message == 'string'
          ? new Y.PrismaClientUnknownRequestError(t.message, { clientVersion: this.config.clientVersion })
          : t;
  }
  #c(t, r, n = !0) {
    ...
    try {
      ...
      if (((globalThis.PRISMA_WASM_PANIC_REGISTRY.set_message = i), o))
        throw (
          ...
          new Y.PrismaClientRustPanicError(Pl(this, o, r), this.config.clientVersion))
        );
    }
  }
  onBeforeExit() {
      ...
      switch (f.type) {
        case 'multi': {
          ...
          return (
            P !== void 0 &&
              r?.kind !== 'itx' &&
              (C ? await this.transaction('rollback', {}, P) : await this.transaction('commit', {}, P)),
            S
          );
        }
        case 'compacted': {
  ...
  #f(t, r) {
    if (Al(t)) return vl(t);
    try {
      return this.#c(() => this.#d({ queries: [t], execute: () => r.compile(JSON.stringify(t)) }));
    } catch (n) {
      throw this.#p(n);
    }
  }
  #g(t, r) {
    ...
    if (n.length === t.batch.length) return { type: 'multi', plans: n.map((i) => vl(i)) };
    try {
      return this.#c(() => this.#d({ queries: t.batch, execute: () => r.compileBatch(JSON.stringify(t)) }));
    } catch (i) {
      throw this.#p(i);
    }
  }
    ...
    switch (t) {
      ...
      default:
        throw new Y.PrismaClientKnownRequestError(
          ...
          { code: 'P2023', clientVersion: this.config.clientVersion, meta: { providedIsolationLevel: t } },
        );
    }
  }
...
function Nl(e, t) {
  ...
  if (Fm(e)) return { prisma__type: 'bytes', prisma__value: y.from(e).toString('base64') };
  if (ArrayBuffer.isView(e)) {
    let { buffer: r, byteOffset: n, byteLength: i } = e;
...
var Um = /^(\s*alter\s)/i,
  Ll = X('prisma:client');
function Mi(e, t, r, n) {
  if (!(e !== 'postgresql' && e !== 'cockroachdb') && r.length > 0 && Um.exec(t))
...
var Ni =
    ...
    (r) => {
      let n = '',
        i;
      if ($r(r)) (n = r.sql), (i = { values: Ct(r.values), __prismaRawParameters__: !0 });
        ...
        switch (t) {
          case 'sqlite':
          case 'mysql': {
            (n = r.sql), (i = { values: Ct(r.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'cockroachdb':
          case 'postgresql':
          case 'postgres': {
            (n = r.text), (i = { values: Ct(r.values), __prismaRawParameters__: !0 });
            break;
          }
          case 'sqlserver': {
            (n = Il(r)), (i = { values: Ct(r.values), __prismaRawParameters__: !0 });
            break;
          }
          default:
...
function Di(e) {
  return function (r, n) {
    let i,
      o = (s = e) => {
        try {
          return s === void 0 || s?.kind === 'itx' ? (i ??= $l(r(s))) : $l(r(s));
        } catch (a) {
  ...
  bn = class {
    ...
    handleRequestError({
      ...
      if (
        ...
        if (t.isPanic) throw new N.PrismaClientRustPanicError(d, this.client._clientVersion);
        ...
        if (t instanceof N.PrismaClientInitializationError)
          throw new N.PrismaClientInitializationError(d, this.client._clientVersion);
    ...
    sanitizeMessage(t) {
      return this.client._errorFormat && this.client._errorFormat !== 'pretty' ? it(t) : t;
    }
    unpack(t, r, n) {
...
function Gm(e, t) {
  return (0, Gl.hasBatchIndex)(e) && t?.kind === 'batch' && e.batchRequestIdx !== t.index;
}
function Km(e) {
...
var Zl = ['errorFormat', 'adapter', 'accelerateUrl', 'log', 'transactionOptions', 'omit', 'comments', '__internal'],
...
var td = { requestArgsToMiddlewareArgs: (e) => e, middlewareArgsToRequestArgs: (e) => e },
...
`,
    ...
    $executeRawUnsafe(n, ...i) {
      return this._createPrismaPromise(
        (o) => (
          Mi(this._activeProvider, n, i, 'prisma.$executeRawUnsafe(<SQL>, [...values])'),
...
function uu() {
  let e = md();
  return { id: e, prettyName: dd[e] || e, isEdge: ['workerd', 'deno', 'netlify', 'edge-light'].includes(e) };
}
